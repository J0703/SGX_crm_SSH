...
<table width="100%" border="1" >
  ...
  <tr class="henglan" style="font-weight:bold;">
    ...
    <s:iterator value="#session.crmDepartments">
        <tr class="tabtd3">
            <td align="center"><s:property value="depName"/></td>
            <td align="center">
                    <%--<a href="${pageContext.request.contextPath}/addOrEditDepartment.action"><img src="${pageContext.request.contextPath}/images/button/modify.gif" class="img" /></a>--%>
                <s:a href="addOrEditDepartment.action?depId=%{depId}"><img src="${pageContext.request.contextPath}/images/button/modify.gif" class="img" >
                </s:a>
            </td>
        </tr>
    </s:iterator>
