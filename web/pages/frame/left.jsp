...
<div class="dtree">
	<script type="text/javascript">
		...
		d.add('010301','0103','班级管理','${pageContext.request.contextPath}/listClass.action','','right');
		...
		d.add('010502','0105','职务管理','${pageContext.request.contextPath}/findAllP.action','','right');
