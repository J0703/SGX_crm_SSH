...
<form action="${pageContext.request.contextPath}/courseTypeAction_findAll.action" method="post">
...
<%--分页数据--%>
     <s:iterator value="#pageBeanCourse.data">
		 <tr class="tabtd2">
	...
	<tr>
	<td align="right">
	<span>第<s:property value="#pageBeanCourse.pageNum"/>/<s:property value="#pageBeanCourse.tatalPage"/>页</span>
	<span>
	<a href="courseTypeAction_findAll.action">[首页]</a>&nbsp;&nbsp;
	<a href="courseTypeAction_findAll.action?pageNum=${pageBeanCourse.pageNum-1}">[上一页]</a>&nbsp;&nbsp;
<a <c:choose><c:when test="${pageBeanCourse.pageNum >= pageBeanCourse.tatalPage}">href="#"</c:when>
   <c:otherwise>href ="courseTypeAction_findAll.action?pageNum=${pageBeanCourse.pageNum+1}"</c:otherwise></c:choose>>[下一页]</a>&nbsp;&nbsp;
	<a href="courseTypeAction_findAll.action?pageNum=${pageBeanCourse.tatalPage}">[尾页]</a>
	</span>
	</td>
	</tr>
	</table>
